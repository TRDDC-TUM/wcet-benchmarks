...
void estimator_init( void ) {
  { TIC(130) /* BBs: 1 */, estimator_x = 0.; estimator_y = 0.; estimator_z = 0.; };
...
void estimator_update_state_infrared( void ) {
  TIC(1074) /* BBs: 5, 6, 7, 8, 9, 10, 13, 14, 15, 16, 11, 12, 4, __floatsisf, __mulsf3, __floatsisf, __mulsf3 */; float rad_of_ir = (TIC(16) /* BBs: 1 */, ir_estim_mode == 1 && ((!0))) ?
    TIC(10) /* BBs: 2 */, estimator_rad_of_ir : TIC(9) /* BBs: 3 */, ir_rad_of_ir;
...
void estimator_update_state_gps( void ) {
  if ((TIC(12) /* BBs: 2, 1 */, gps_mode == 3)) {
    { TIC(104) /* BBs: 3 */, estimator_x = gps_east; estimator_y = gps_north; estimator_z = gps_falt; };
    { estimator_hspeed_mod = gps_fspeed; estimator_hspeed_dir = gps_fcourse; estimator_z_dot = gps_fclimb; };
    if (estimator_flight_time)
      TIC(4) /* BBs: 6, 5, estimator_update_ir_estim */, estimator_update_ir_estim();
  }
TIC(9) /* BBs: 4 */; }
void estimator_propagate_state( void ) {
TIC(14) /* BBs: 1 */; }
